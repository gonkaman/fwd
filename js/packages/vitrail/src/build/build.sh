...
rm -Rf ../../dist/*
deno compile --allow-write --target x86_64-unknown-linux-gnu -o serenia ./tmp/index.ts
tar -czvf ../../dist/serenia-linux-preview-1.tar.gz serenia
deno compile --allow-write --target x86_64-pc-windows-msvc -o serenia.exe ./tmp/index.ts
